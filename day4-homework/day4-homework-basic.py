...
plt.figure()
plt.plot(fpkms_female, c="red")
plt.plot(fpkms_male, c="blue")
plt.plot(rep_fpkms_f, 'o', c="orange")
plt.plot(rep_fpkms_m, 'o', c="purple")
plt.xticks(range(len(fpkms_female)), df_samples["stage"])
